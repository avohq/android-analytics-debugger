// Generated by Avo VERSION 51.15.0, PLEASE EDIT WITH CARE
package sh.avo;
...
private static class AvoInvoke {
    ...
    static void _invoke(String eventId, String hash, List<AvoAssertMessage> messages) throws JSONException {
        if (samplingRate > 0) {
            if (Math.random() < samplingRate) {
                ...
                json.put("ac", "ZVGfjnrSNGJSBWsci5cK");
                json.put("br", "master");
                json.put("en", "dev");
                json.put("ev", eventId);
                json.put("ha", hash);
    ...
    public static void initAvo(AvoEnv env,
        ...
        initAvo(env, customDestination, null, debuggerManager);
    }
    ...
    public static void appOpened() {
        // assert properties
        if ((__AVO_ENV__ != AvoEnv.PROD) || (__AVO_ENV__ == AvoEnv.PROD && __MOBILE_DEBUGGER_ENABLED__())) {
            final List<AvoAssertMessage> messages = new ArrayList<>();
            // debug console in Avo
    ...
    public static void play(final String currentSongName) {
        ...
        if ((__AVO_ENV__ != AvoEnv.PROD) || (__AVO_ENV__ == AvoEnv.PROD && __MOBILE_DEBUGGER_ENABLED__())) {
            ...
            if (__AVO_ENV__ != AvoEnv.PROD && ((__STRICT__ == null && !(__MOBILE_DEBUGGER_ENABLED__())) || (__STRICT__ != null && __STRICT__))) {
